...
- Environment variables:
  - `DBCLI_CONNECTION`: Database connection string (required)
...
export DBCLI_CONNECTION="Data Source=app.db"
cat migration.sql | dbcli interactive
```
